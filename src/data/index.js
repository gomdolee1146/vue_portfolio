...
export const portContent = [
  ...
  },
  {
    ...
    desc: `v-calendar를 활용해 달력 화면을 만들었습니다.\n 토글버튼을 활용하여, 해야할 일과 완료한 일을 구분할 수 있도록 했습니다.`,
    thumb: 'port04.png',
  ...
  },
  {
    num: '05',
    title: '음료수 자판기',
    desc: `바닐라 자바스크립트로 만든 음료수 자판기입니다. \n새로고침을 할 때마다 랜덤으로 주어지는 지갑 안의 돈을 이용해, \n음료수를 선택할 수 있는 화면을 만들었습니다.`,
    thumb: 'port05.png',
